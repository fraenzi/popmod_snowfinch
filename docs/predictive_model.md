...
For the population model, we adapted an average proportion of non-breeding females of 0.1 along with an uncertainty interval of 0.03 to 0.22. The large uncertainty interval accounts for the fact that we know little about this demographic parameter. 
...
Our own data from Switzerland (2015-2023) contains 80 broods for which the number of fledglings is known. The average number of fledglings was almost 4 chicks for broods early in the breeding season and it decreases to around 3 fledglings for late broods (Fig. \@ref(fig:nrfeldglings)).
